                        ...
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <tbody>
                                    <?php foreach($letter as $vo):?>
                                        <tr id="<?=$vo['id']?>">
                                            <td><?=$vo['id']?></td>
                                            <td><?=$vo['name']?></td>
                                            <td><?=$vo['url']?></td>
                                            <td><a class="btn btn-primary btn-xs" href="<?=Url::toRoute(['letter/update','id'=>$vo['id']])?>"><i class="fa fa-edit"></i>修改</a>  <a id="del" class="btn btn-default btn-xs">删除</a></td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
                                </table>
