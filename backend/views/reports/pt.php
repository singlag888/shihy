                            ...
                            <div class="table-responsive">
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">入款金额 / 笔数 / 平均</th>
                                        <th class="text-center">出款金额 / 笔数 / 平均</th>
                                        <th class="text-center">平台活动金额 / 笔数 / 平均</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php foreach ($in as $v):?>
                                    <tr>
                                        <td><?=$v['username']?></td>
                                        <td><?=$v['in_price']?> / <?=$v['in_count']?> / <?=$v['in_aug']?></td>
                                        <td><?=$v['out_price']?> / <?=$v['out_count']?> / <?=$v['out_aug']?></td>
                                        <td><?=$v['my_price']?> / <?=$v['my_count']?> / <?=$v['my_aug']?></td>
                                    </tr>
                                    <?php endforeach;?>
                                    </tbody>
                                </table>
