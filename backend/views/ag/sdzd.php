                        ...
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    <thead>
                                    <tr>
                                        <th class="text-center"><h1>手动转点</h1></th>

                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr id="">
                                        <td>转出账号 : <input type="text" name="username">  转入账号 : <input type="text" name="username"><a  class="btn btn-danger btn-xs">查询</a>  <a  class="btn btn-danger btn-xs">重置</a></td>
                                    </tbody>
                                </table>
                            </div>
                        </div>
