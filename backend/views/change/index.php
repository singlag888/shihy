                                ...
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <?php foreach($model as $vo):?>
                                        <tr id="<?=$vo['id']?>">
                                            ...
                                            <td><?=$vo['type']?></td>                                                <td><?=$vo['last_price']?></td>
                                            <td><?=$vo['price']?></td>
                                            <td><?=$vo['game_type']?></td>
                                            <td><?=$vo['intro']?></td>
                                            <td><a class="btn btn-info btn-xs" href="<?=Url::toRoute(['change/update','id'=>$vo['id']])?>"><i class="fa fa-edit"></i>修改</a>  <a id="del" class="btn btn-danger btn-xs">删除</a></td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
                                </table>
