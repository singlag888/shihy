                                ...
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <?php foreach ($model as $v): ?>
                                        <tr id="<?=$v->id?>">
                                            ...
                                            <td><?=$v->rebate ?></td>
                                            <td>
                                                <a class="btn btn-primary btn-xs" href="<?=Url::toRoute(['rebate/update','id'=>$v['id']])?>"><i class="fa fa-edit"></i>编辑</a> <a id="del" class="btn btn-default btn-xs">删除</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
...
$url = \yii\helpers\Url::to(['rebate/delete']);
$js =
    <<<JS
