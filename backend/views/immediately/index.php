                            ...
                            <div class="table-responsive">
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">发布对象</td>
                                        <td class="text-center">公告类型</td>
                                        <td class="text-center">生效时间</td>
                                        <td class="text-center">结束时间</td>
                                        <td class="text-center">发布者</td>
...
<!--                                    <?php /*foreach ($model as $v): */?>
                                        <tr id="<?/*=$v->id*/?>">
                                            ...
                                            <td><?/*=$v->status==1?'正常':'失效' */?></td>
                                            <td>
                                                <a class="btn btn-primary btn-xs" href="<?/*=Url::toRoute(['immediately/update','id'=>$v['id']])*/?>"><i class="fa fa-edit"></i>编辑</a> <a id="del" class="btn btn-default btn-xs">删除</a>
                                            </td>
                                        </tr>
                                    --><?php /*endforeach; */?>
                                    </tbody>
...
$url = \yii\helpers\Url::to(['article-detail/delete']);
$js =
    <<<JS
