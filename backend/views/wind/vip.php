                            ...
                            <div class="table-responsive">
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">分层名称</th>
                                        <th class="text-center">最低入款笔数</th>
                                        <th class="text-center">最低入款总额</th>
                                    ...
                                    <?php foreach($model as $vo):?>
                                        <tr id="<?=$vo['id']?>">
                                            ...
                                            <td><?=$vo['max']?></td>
                                            <td><?=$vo['intro']?></td>
                                            <td><?=date('Y-m-d H:i:s',$vo->updated_time)?></td>
                                            <td><a class="btn btn-primary btn-xs" href="<?=Url::toRoute(['wind/update','id'=>$vo['id']])?>"><i class="fa fa-edit"></i>修改</a>  <a id="del" class="btn btn-default btn-xs">删除</a></td>
                                        </tr>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
