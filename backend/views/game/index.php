                            ...
                            <div class="table-responsive">
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">彩种,玩法名称</th>
                                        <th class="text-center">投注号码</th>
                                        <th class="text-center">投注金额</th>
                                        <th class="text-center">中奖金额</th>
                                        <th class="text-center">变动类型</th>
                                        <th class="text-center">变动后的金额</th>
                                        <th class="text-center">变动时间</th>
                                        <th class="text-center">备注</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php foreach($game as $vo):?>
                                        <tr id="<?=$vo['id']?>">
                                            <td><?=$vo['id']?></td>
                                            <td><?=$vo->username?></td>
                                            <td><?=$vo->num?></td>
                                            <td><?=$vo['name'].','.$vo['title']?></td>
                                            <td><?=$vo->number?></td>
                                            <td><?=$vo->price?></td>
                                            <td><?=$vo->change_amount?></td>
                                            <td><?=$vo->type==1?'盈利':'亏损'?></td>
                                            <td><?=$vo->amount?></td>
