                                ...
                                <table id="table_id_example" class="table table-striped table-bordered text-center">
                                    ...
                                    <?php foreach($model as $vo):?>
                                        <tr id="<?=$vo['id']?>">
                                            ...
                                            <td><?=$vo['text']?></td>
                                            <td><?=$vo['intro']?></td>
                                            <td><?=$vo['status']==1?'<span class="btn btn-info btn-xs">启用</span>':'<span class="btn btn-danger btn-xs">禁止</span>'?></td>
...
$url = \yii\helpers\Url::to(['receipt/delete']);
$js =
    <<<JS
